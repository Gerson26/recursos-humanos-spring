...
//revisar si lo puedo cambiar por *
...
public class EmpleadoControlador {
    ...
    @Autowired
    //si no funciona lo dejamos con IEmpleadoServicio
    ...
    public ResponseEntity<Empleado> obtenerEmpleadoPorId(@PathVariable Integer id){
        ...
        if (empleado == null) throw new RecursoNoEncontradoExepcion("No se encontro el id: "+id);
    ...
    public ResponseEntity<Empleado> actualizarEmpleado(@PathVariable Integer id, @RequestBody Empleado empleadoRecibido){
        Empleado empleado = empleadoServicio.buscarEmpleadoPorId(id);
        if (empleado == null) throw new RecursoNoEncontradoExepcion("El id recibido no existe: "+id);
        empleado.setNombre(empleadoRecibido.getNombre());
        empleado.setDepartamento(empleadoRecibido.getDepartamento());
        empleadoRecibido.setSueldo(empleadoRecibido.getSueldo());
